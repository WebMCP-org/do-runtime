...
On 2026-09-13, real-profile measurement retired Think’s two-message read-window
override. Among 241 recent assistant messages, the median was 26.3 KB and the
maximum 586.4 KB; none exceeded 1 MB. Replaying the retained histories preserved
additional detail at 81 of 239 user-message endpoints with upstream’s four-message
window. Keep the compaction head/tail floors and structured-output truncation
separate: they address different boundaries. Native model-conversion tests cover
the third/fourth intact messages and fifth-message truncation.
