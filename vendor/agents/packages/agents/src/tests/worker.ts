...
export {
  TestAgentToolLifecycleParent,
  TestAgentToolLifecycleWindowParent,
  TestAgentToolLifecycleChild
} from "./agents/agent-tool-lifecycle";
import type {
  TestAgentToolLifecycleParent,
  TestAgentToolLifecycleWindowParent
} from "./agents/agent-tool-lifecycle";
...
export type Env = {
  ...
  TestAgentToolLifecycleWindowParent: DurableObjectNamespace<TestAgentToolLifecycleWindowParent>;
