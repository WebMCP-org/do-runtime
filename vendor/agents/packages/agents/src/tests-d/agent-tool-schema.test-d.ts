...
// @ts-expect-error A ready collection always carries its authoritative roster.
const readyWithoutRoster: AgentToolCollectionMessage["event"] = {
  kind: "collection",
  status: "ready"
};
void readyWithoutRoster;

// @ts-expect-error An error collection always carries its diagnostic.
const errorWithoutDiagnostic: AgentToolCollectionMessage["event"] = {
  kind: "collection",
  status: "error"
};
